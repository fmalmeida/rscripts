...
amrtsv <- try(read.delim("/home/falmeida/Documents/pipe_testing/output/AMRFinder_output.tsv") %>% select(1,2,3,4,5,7,9,15), silent = TRUE)

#ncbi_amr <- try(read.delim(params$ncbi_amr), silent = TRUE)
ncbi_amr <- try(read.delim("/home/falmeida/Documents/pipe_testing/output/teste_amrfinderplus.tsv"), silent = TRUE)
