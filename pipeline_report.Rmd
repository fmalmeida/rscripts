...
## Load resistance gff file
resistance_gff_file <- params$resistance_gff_file
## Get resistance summary path
resistance_summary <- params$resistance_summary
## Loading resistance summary table
...
## Loading ICEberg summary table file
ice_summary_file <- params$ice_summary_file
## ICEberg gff filepath
ice_gff <- params$ice_gff
## Loading ICEberg gff file
ice_gff_file <- params$ice_gff_file
# Get PHAST variables
## Was PHAST executed?
...
gffFile <- ballgown::gffRead(params$gff_file)
gffFile
```
