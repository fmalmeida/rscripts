...
In order to properly extract information from the .sql file produced in the end of the annotation pipeline I recommend using my `parse_sql.R` file available in my [rscripts repository](https://github.com/fmalmeida/rscripts).

Checking help: `./parse_sql.R -h`