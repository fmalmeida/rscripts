...
## Read PHAST
phast_blast <- try(read.delim("/media/falmeida/falmeidaEXT/k.variicola/ANNOTATION/18L/blasts/prophage_phast_predictedGenes.tsv", header = FALSE, col.names = c("qseqid", "sseqid", "pident", "length", "mismatch", "gapopen", "qstart", "qend", "sstart", "send", "slen", "evalue", "bitscore", "stitle")), silent = TRUE)
...
```{r, phigaro_conditional_block_TRUE, echo=FALSE, results='asis', eval=visorter_not_null, child='yes_virsorter.Rmd'}
```
