...
# Example usage
# Rscript -e 'rmarkdown::render("/work/rscripts/report_virulence.Rmd" , params = list( vfdb_blast = "/media/falmeida/falmeidaEXT/k.variicola/ANNOTATION/18L/blasts/virulence_vfdb_predictedGenes.tsv", blast_id = 90 , blast_cov = 90))'
```
...
blast %>% select("Virulence Factor Name", "VF ID", "Gene Name", "Description", "Subject Species") %>%
  ...
  kable_styling(bootstrap_options = bt_opt, full_width = T, fixed_thead = T) %>%
