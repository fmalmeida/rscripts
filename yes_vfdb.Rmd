...
full_info$position <- paste(full_info$V1.y, ":", full_info$V4.y, "-", full_info$V5.y, sep = "")
...
blast %>% select("Virulence Factor Name", "VF ID", "Gene Name", "Description", "Subject Species", "Query Protein ID", "Query Protein Coordinates") %>%
