...
This is well documented in the Table below. Whenever possible, all feature have links to NCBI database marking the closest reference sequence to each annotated gene. A summary of the Antibiotic Classes target by ARGs annotated is shown in Figure \@ref(fig:ncbi-resistome-png).
