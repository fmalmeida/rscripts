...
Strict hits genes are genes annotated with looser parameters and are not surely functional or correct. Which means, users should double check genes under this category. A summary of the Antibiotic Classes target by ARGs annotated as Strict hits is shown in Figure \@ref(fig:rgi-strict-resistome-png).

```{r rgi-strict-resistome-png, fig.align='center', fig.show='hold', fig.cap="Resistome Predicted using CARD RGI tool", out.width="60%"}
